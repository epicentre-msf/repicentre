...
description : Session complémentaire au module FETCH d'enquête
...
Si vous avez besoin de revoir ou d'apprendre l'un de ces sujets, veuillez vous reporter aux [sessions de base du parcours d'apprentissage](pathway.html).
...
- Chez qui y'a-t-il plus de décès, les hommes ou les femmes ? Qui était le plus à risque ?
...
downloadthis::download_link(
  link = 'https://github.com/epicentre-msf/repicentre/blob/main/solutions/companion/survey_solutions.R',
