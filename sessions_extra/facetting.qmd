---
title: Introduction to faceting
description: Create a plot with multiple subplots (facets)
date: last-modified
image: ../img/satellite/faceting/faceting_000_logo.png
categories:
  - Satellite
  - Graphs
  - ggplot2
...
This satellite builds on the core [epicurve session](../session_core/06_epicurves.qmd), which is a prerequisite. In that session, we learned how to create an epicurve of measles cases across time: 
...
downloadthis::download_link(
  link = 'https://github.com/epicentre-msf/repicentre/raw/refs/heads/main/data/data/clean/moissala_linelist_clean_EN.rds',
...
Depending on the size of your graph, the date labels on the x-axis may be a bit messed up, the ones in my examples definitely are. Fear not, this can be controlled and is the object of another [satellite](../session_extra/weekly_epicurves.qmd)!
...
downloadthis::download_link(
  link = 'https://github.com/epicentre-msf/repicentre/blob/main/sessions_extra/faceting_solutions.R',
...
You will need two aggregated data frames, one created today and one created in the [epicurve session](../session_core/06_epicurves.qmd).
:::
