...
::: {.write}
You will draw a plot of the number of admissions by age group, so you need a new data frame summarized by week and age group. Create this data frame, and call it `df_age`. It should have this format:
