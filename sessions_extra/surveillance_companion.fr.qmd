...
C'est la fin de la question 3. Si vous terminez en avance, finissez l'inspection des données, listez les problèmes et nettoyez les colonnes que vous savez nettoyer avant de réexporter. Si c'est fait, lisez les eplications sur la fonction `complete()` et allez explorer sa [page d'aide](https://tidyr.tidyverse.org/reference/complete.html).
