...
path_data_raw <- here('data', 'session-specific', 'import-multiple', 'satellite_multiple_FR',
                      'data', 'raw')
...
downloadthis::download_link(
  link = 'https://github.com/epicentre-msf/repicentre/raw/main/data/session-specific/import-multiple/satellite_multiple-importation_FR.zip',
  button_label = 'Dossier de la Session',
  has_icon = TRUE,
  icon = "fa fa-save",
