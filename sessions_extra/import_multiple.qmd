...
- the `\\.` at the start is the [regex way]{.hovertip bs-toggle='tooltip' bs-title='It sounds complicated because the "." alone has a special meaning in regex, so we need to add the \\. Go [read on regex](https://r4ds.hadley.nz/regexps), or trust us for now.'} of saying that there should be a "." before "doc".
