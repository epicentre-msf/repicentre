...
path_data_raw <- here('data', 'session-specific', 'import-multiple', 'satellite_multiple_EN',
                      'data', 'raw')
...
::: {.setup}
Download and decompress the below folder containing data and an `.Rproj` file for this session. 
```{r}
#| echo: false
#| eval: true

downloadthis::download_link(
  link = 'https://github.com/epicentre-msf/repicentre/raw/main/data/session-specific/import-multiple/satellite_multiple-importation_EN.zip',
  button_label = 'Session Folder',
  has_icon = TRUE,
  icon = "fa fa-save",
...
<br><br>
Navigate into the new folder and create a new script called `import_multiple.R`. Add an appropriate header to the script and load `{rio}` and `{here}`. Create a `path_data_raw` object that points to the directory `data/raw` of the course folder.
:::
...
::: {.look}
Go to the sub-folder `data/raw/multiple_files/`. Open the Excel files to check their content. Would it make sense to concatenate the data together at import in this case?
:::
