...
**Prérequis** : ce satellite s'appuie sur la session sur les [courbes épidémiques](../session_core/07_epicurves.qmd), durant laquelle nous avons appris à visualiser la distribution quotidienne des cas de rougeoles au cours du temps à l'aide de `{ggplot2}` :
...
Il vous faudra deux data frame agrégés, l'un deux crée aujourd'hui et l'autre lors de la session sur les [courbes épis](../session_core/07_epicurves.qmd).
:::
