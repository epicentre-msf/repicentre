...
<br>
Add a section to your script called `# IMPORT DATA` where you import the *clean course dataset* (`moissala_linelist_clean_EN.rds`).
:::
...
1. Create an epicurve of the date of consultation. Do not forget to update the titles and captions.
