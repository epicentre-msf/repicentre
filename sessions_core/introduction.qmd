...
- *Packages.* A list of all the R <span class='hoverinfo' data-toggle='tooltip' title="Packages are simply collections of functions that help extend the functionality of R. We will discuss them in greater detail in the next lesson.">packages</span> installed on your computer.
