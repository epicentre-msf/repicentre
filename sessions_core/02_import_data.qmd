...
- Clicking on <span class='hoverinfo' data-toggle='tooltip' title="You can also refer to this button at any time to see which project you are currently working in.">the `Project: (none)` button</span> on the top right of the RStudio interface (see [interface](../sessions_core/02_import_data.qmd#fig-interface)
