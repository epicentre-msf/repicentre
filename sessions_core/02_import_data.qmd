...
downloadthis::download_link(
  link = 'https://github.com/epicentre-msf/repicentre/raw/main/data/scenarios/TCH_measles/mandoul_measles_starter.zip',
...
- Satellite session on [importing multiple files or multiple sheets from a single (Excel) file](../sessions_extra/import_multiple.qmd)
