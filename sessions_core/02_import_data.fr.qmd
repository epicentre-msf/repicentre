...
downloadthis::download_link(
  link = 'https://github.com/epicentre-msf/repicentre/raw/main/data/scenarios/TCH_measles/mandoul_rougeole_starter.zip',
...
Notez que nous avons imbriqué la commande `here()` **à l'intérieur** de la commande `import()`. L'imbrication de fonctions est courante en R. R évalue les fonctions imbriquées de l'intérieur (`here()`) à l'extérieur (`import()`). La valeur renvoyée par `here()` est donc utilisée comme *valeur d'entrée* d'`import()`.
