...
- Ssession atellite sur [l'importation de plusieurs fichiers ou de plusieurs feuilles à partir d'un seul fichier (Excel)](../sessions_extra/import_multiple.qmd)
