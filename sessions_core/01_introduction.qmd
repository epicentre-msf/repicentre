...
That's all for this session! Congratulations, you learned about the Rstudio interface, how to use the console for basic calculations, the most common types of objects and how to explore and manipulate them, and a couple of useful functions already!
