...
- *Files.* A file explorer for the working directory, which is the folder location (directory) where R is currently working. We will talk more about it in the next session.
...
XXXXXXXXXXXXXX {.hoverinfo toggle='tooltip' title='You will learn later this lesson that in R, pretty much everything is an object, including functions, scalar values, and other more complex data structures'}  XXXXXXXXXXXXXXXXXXXXX
