...
The use of hardcoded absolute paths is **strongly discouraged** as they would need to be changed every time your code is shared or the project folder is moved; if not, the code would no longer run properly.
