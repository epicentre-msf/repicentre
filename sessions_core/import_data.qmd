...
**Code.** Add some metadata to the top as seen in the first session using [comments](01_introduction.qmd#sec-comments). Be sure to include:
...
We can install a new package using the [function](../sessions_core/01_introduction.qmd#sec-functions) `install.packages()`, which downloads and installs it into the package library on your computer. 
