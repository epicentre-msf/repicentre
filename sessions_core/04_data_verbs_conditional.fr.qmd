...
6. **Corriger** : quelqu'un a tenté de corriger le code ci-dessus, mais a commis quelques erreurs (vicieuses, elles n'empêchent pas la commande de s's'exécuter, mais le résultat est faux !). Essayez de les corriger. Vous savez que vous avez tout corrigé quand vous obtenez le même résultat qu'auparavant.
