...
1. **Conditions** : les tests logiques ne se restreignent pas à `filter()` et `case_when()`. On peut aussi les utiliser avec des vecteurs. Si nous créons les deux vecteurs suivants : 
