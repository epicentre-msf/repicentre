...
::: {.setup}
This session will work with the **raw** Mandoul linelist data, which can be downloaded here:
...
downloadthis::download_link(
  link = 'https://github.com/epicentre-msf/repicentre/raw/refs/heads/main/data/scenarios/TCH_measles/raw/moissala_linelist_EN.xlsx',
